-- Complete Database Schema Setup for SchoolQuiz (Simplified - No Index Checks)
...
-- ============================================================================
-- Indexes (create with error handling - will skip if already exists)
-- ============================================================================
...
-- Question indexes (only create if table exists - wrap in DO block to catch errors)
DO $$
BEGIN
  BEGIN
