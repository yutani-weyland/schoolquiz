...
const FINALE_ROUND_NUMBER = QUIZ_CONSTANTS.PEOPLES_ROUND_NUMBER;
const FINALE_QUESTION_COUNT = QUIZ_CONSTANTS.PEOPLE_ROUND_QUESTION_COUNT;
const TOTAL_QUESTIONS_EXPECTED = QUIZ_CONSTANTS.TOTAL_QUESTIONS;
