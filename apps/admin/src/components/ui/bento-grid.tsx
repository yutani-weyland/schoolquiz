...
const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid w-full auto-rows-[22rem] grid-cols-1 md:grid-cols-3 gap-2 lg:gap-4",
        className
      )}
    >
      {children}
    ...
    {href && href !== "" && (
      ...
      >
        ...
        >
          <a href={href}>
            {cta}
            <ArrowRight className="ml-2 h-4 w-4 lg:group-hover/Arrow:translate-x-1 transition-transform duration-300" />
          </a>
        </Button>
      </div>
    )}
