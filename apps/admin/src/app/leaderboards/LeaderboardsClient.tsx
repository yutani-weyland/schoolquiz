...
import type { LeaderboardsPageData, Leaderboard } from './leaderboards-server'
...
interface LeaderboardsClientProps {
	initialData: LeaderboardsPageData
}
...
export function LeaderboardsClient({ initialData }: LeaderboardsClientProps) {
	...
	const [leaderboards, setLeaderboards] = useState(initialData.leaderboards)
