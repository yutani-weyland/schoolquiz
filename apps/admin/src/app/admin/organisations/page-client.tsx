...
export default function OrganisationsClient({
  ...
  const [statusFilter, setStatusFilter] = useState(initialSearchParams?.status || searchParams.get('status') || '')
  ...
  useEffect(() => {
    const paramsChanged = 
      ...
      statusFilter !== (initialSearchParams?.status || '') ||
                      ...
                      return (
                        ...
                        >
                          ...
                          <DataTableCell className="text-sm text-[hsl(var(--muted-foreground))]">
                            <span title={new Date(org.createdAt).toLocaleString('en-US', {
                              year: 'numeric',
                              month: '2-digit',
                              day: '2-digit',
                              hour: '2-digit',
