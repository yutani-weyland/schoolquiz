...
import type { ExploreQuizzesPageData, Quiz } from './explore-quizzes-server'
import type { ExploreQuizzesPageData, Quiz } from './explore-quizzes-server'
...
interface ExploreQuizzesClientProps {
	initialData: ExploreQuizzesPageData
}

export function ExploreQuizzesClient({ initialData }: ExploreQuizzesClientProps) {
	...
	// Client-side filtering and refetching
	useEffect(() => {
		const shouldRefetch = filterStatus !== 'all' || searchQuery.length > 0
		if (shouldRefetch) {
			fetchQuizzes()
		}
      ...
      <main className="pt-20 px-6">
        <div className="max-w-full mx-auto">
          ...
          {isLoading ? (
            ...
            // Show skeleton grid inline as fallback
