...
export default function RailProgress({
	...
	return (
		<div 
			...
			className={`fixed bottom-0 left-0 right-0 z-40 w-full pb-safe py-6 transition-colors duration-700 ease-in-out ${className}`}
		...
		>
			...
			<div className="flex justify-center">
				<div
					...
					className="flex gap-2 scrollbar-hide py-2 max-w-full overflow-x-auto overflow-y-visible"
					style={{ 
						paddingLeft: '24px', 
						paddingRight: '24px',
						...
						if (isCurrent) {
							if (isViewed && !isAttempted) {
								buttonStyle = { 
									...
									color: "white", 
									boxShadow: "0 0 0 4px rgba(11, 11, 11, 0.3), 0 0 12px rgba(11, 11, 11, 0.5)" 
								};
								displayContent = n;
							} else if (isCorrect) {
								buttonStyle = { 
									...
									color: "white", 
									boxShadow: "0 0 0 4px rgba(16, 185, 129, 0.3), 0 0 12px rgba(16, 185, 129, 0.5)" 
								};
								displayContent = <Check className="w-6 h-6" strokeWidth={3} />;
							} else if (isIncorrect) {
								buttonStyle = { 
									backgroundColor: "#EF4444", 
									color: "white", 
									boxShadow: "0 0 0 4px rgba(239, 68, 68, 0.3), 0 0 12px rgba(239, 68, 68, 0.5)" 
								};
								displayContent = <X className="w-6 h-6" strokeWidth={3} />;
							} else {
								buttonStyle = { 
									backgroundColor: "#0B0B0B", 
									color: "white", 
						...
						return (
							...
							>
								<button
									...
									className="inline-flex h-16 w-16 items-center justify-center rounded-full text-lg font-semibold tabular-nums focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black/20"
									style={{
										...buttonStyle,
