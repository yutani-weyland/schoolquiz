  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-dvh flex-col">
        <header
          ...
          style={{
            background:
              themeMode === "colored"
                ? `${baseColor}d0`
                : "linear-gradient(180deg, rgba(255,255,255,0.22), rgba(255,255,255,0.04) 70%, transparent)",
        ...
        >
          <div className="mx-auto flex w-full max-w-5xl flex-col">
            <h1
              ...
              style={{
                fontSize: "clamp(2rem, 1.2rem + 2.4vw, 3.4rem)",
                lineHeight: 1.05,
                color: textIsLight ? "#fffef7" : "var(--color-text)",
              }}
            >
              {quizTitle}
            </h1>
              ...
              return (
                <React.Fragment key={question.id}>
                  ...
                  <motion.article
                    ...
                    className="group relative flex flex-col gap-8 overflow-hidden rounded-[26px] border px-6 py-8 transition-transform duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] sm:px-10 sm:py-10"
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="flex flex-1 flex-col gap-6">
                        <motion.h2
                          layout
                          className="text-left font-extrabold tracking-tight text-balance"
                          style={{
        ...
        >
          <div
            className="pointer-events-auto rounded-full px-5 py-3 text-[clamp(0.95rem,0.85rem+0.4vw,1.15rem)] font-semibold tracking-[0.14em] sm:px-6 sm:py-3.5"
            style={{
