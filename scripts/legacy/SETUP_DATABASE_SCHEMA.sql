...
-- Note: This creates tables in dependency order
-- If tables already exist, the IF NOT EXISTS clauses will skip them
...
-- User Question Submissions (this was missing!)
...
CREATE INDEX IF NOT EXISTS "user_question_submissions_status_createdAt_idx" ON user_question_submissions(status, "createdAt");
CREATE INDEX IF NOT EXISTS "user_question_submissions_userId_idx" ON user_question_submissions("userId");
